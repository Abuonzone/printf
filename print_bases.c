...
/**
 * print_big_hex - prints a number in hexadecimal base in uppercase
 * @l: va_list arguments from _printf
 * @f: pointer to the struct that determines if a flag is passed to printf
 ...
 * @l: va_list arguments from _printf
 * @f: pointer to the struct that determines is a flag is passed to printf
 * Return: the number of char printed
 */
